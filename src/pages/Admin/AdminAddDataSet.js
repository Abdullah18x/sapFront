...
class AdminAddDataSet extends Component{
  ...
  saveDataSet = async () => {
    try {
      ...
      if(this.state.title==='' || this.state.subject===0 || !this.state.fileName.localeCompare('Choose File') || this.state.details==='' || this.state.resourceLinks==='' || this.state.solution===''){
    ...
    if(this.state.loggedIn){
      ...
      <div className="card">
        ...
        <div className="m-t-25">
            ...
            <div className="form-row" id="assignNowRow" style={{display:''}}>
