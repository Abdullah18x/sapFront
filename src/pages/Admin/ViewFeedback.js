...
class ViewAssignedAssignment extends Component {
  ...
  getFeedback = async () => {
    try {
      let getFeedback = await admin.getfeedback(
  ...
  getComments = async () => {
    try {
      let comments = await admin.getComments(
        this.props.location.state.fbId,
        this.state.token
      );
      this.setState({
  ...
  comment = async () => {
    ...
    try {
      ...
      let userDetails = "Admin (".concat(getAdmin.userName.concat(")"));
      alert('here')
      console.log(userDetails)
      if (this.state.comment != "") {
        let addComment = await admin.comment(
          this.props.location.state.fbId,
          userDetails,
          this.state.comment,
          this.state.token
